function plot_toeoff_events()
% plot_to_events_TO
% Liest 3 TXT-Dateien per uigetfile ein und plottet Toe-Off (TO):
% - Positionsdaten als Linien (LeftToe_PosY / RightToe_PosY)
% - Marker-TO als Punkte auf der Linie
% - Forceplate-TO als vertikale Linien
%
...
eventName = "TO";  % <<< NUR HIER ändern (TO)
...
reqPos = ["SampleIdx","Time_s","LeftToe_PosY","RightToe_PosY"];
...
% Linien (TOE!)
hL = plot(xPos, pos.LeftToe_PosY,  'b', 'LineWidth',1.5);
hR = plot(xPos, pos.RightToe_PosY, 'r', 'LineWidth',1.5);
...
% Legende
legendHandles = [hL, hR];
legendNames   = {'LeftToe_PosY','RightToe_PosY'};
